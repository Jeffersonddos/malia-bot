...
let res = await fetchJson(`https://raw.githubusercontent.com/Riskyzin/riskyvpn/main/teste.json`)
...
handler.tags = ['game']
handler.command = /^cancion|musica$/i

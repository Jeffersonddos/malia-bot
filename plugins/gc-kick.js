...
let kicktext = `*[❗] MARQUE UMA PESSOA OU UMA MENSAGEM DA PESSOA PARA BANI-LA*`
...
if(conn.user.jid.includes(mentioned)) return m.reply("*[❗] NÃO POSSO ME BANIR. RE REMOVA MANUALMENTE.*")
...
let error1 = `*@${mentioned.split("@")[0]} [ ERRO AO REMOVER ] - ( Motivo: É o criador. )*`
let error2 = `*@${mentioned.split("@")[0]} [ ERRO AO REMOVER ] - ( Motivo: Já foi removido. )*`
if (responseb[0].status === "200") m.reply(exitoso1, m.chat, { mentions: conn.parseMention(exitoso1)})  
else if (responseb[0].status === "406") m.reply(error1, m.chat, { mentions: conn.parseMention(error1)})   
else if (responseb[0].status === "404") m.reply(error2, m.chat, { mentions: conn.parseMention(error2)})  
else conn.sendMessage(m.chat, {text: `*[❗] OCORREU UM ERRO*`, mentions: [m.sender], contextInfo:{forwardingScore:999, isForwarded:true}}, {quoted: m})

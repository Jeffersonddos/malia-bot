...
conn.sendMessage(m.chat, { image: { url: haha }, caption: `_${command}_`}, { mentions: [who] })}
if (command == 'pubg') {
...
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, res2, [['🎐 | PRÓXIMA', `/${command}`]], fgif, { mentions: [who] })}

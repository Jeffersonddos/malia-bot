...
//conn.sendButton(m.chat, `_🥵 Pack 🥵_`, author, url, [['🎐 | PRÓXIMA', `${usedPrefix + command}`]], m)
break
case "pack2":  
let url2 = await packgirl[Math.floor(Math.random() * packgirl.length)]
conn.sendMessage(m.chat, { image: { url: url2 }, caption: command }, { quoted: m })
//conn.sendButton(m.chat, `_🥵 Pack 2 🥵_`, author, url2, [['🎐 | PRÓXIMA', `${usedPrefix + command}`]], m) 
break
case "pack3":
let url3 = await packmen[Math.floor(Math.random() * packmen.length)]
conn.sendMessage(m.chat, { image: { url: url3 }, caption: command }, { quoted: m })
//conn.sendButton(m.chat, `_🥵 Pack 3 🥵_`, author, url3, [['🎐 | PRÓXIMA', `${usedPrefix + command}`]], m) 
break
case "videoxxx": case "vídeoxxx":    
let url4 = await videosxxxc[Math.floor(Math.random() * videosxxxc.length)] 
await conn.sendMessage(m.chat, { video: { url: url4 }, caption: command }, { quoted: m })
//await conn.sendButton(m.chat, `*Aproveite o vídeo 🥵*`, author, url4, [['🎐 | PRÓXIMA', `${usedPrefix + command}`]], m)  
break  
...
await conn.sendButton(m.chat, `*Aproveite o vídeo 🥵*`, author, url5, [['🎐 | PRÓXIMA', `${usedPrefix + command}`]], m)    
break    
}}

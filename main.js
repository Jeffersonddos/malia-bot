...
const connectionOptions = {
  ...
  browser: ['Malia(Risky)','Safari','1.0.0']
}
...
setInterval(async () => {
	...
	console.log(chalk.cyan(`✅  Auto Limpeza  | Pasta TMP limpa!`))
}, 60000) //1 munto
...
conn.sDesc = '*Nova descrição:*\n @desc'
conn.sSubject = '*Novo nome:* @subject'
conn.sIcon = '*Foto do grupo modificada!!*'
conn.sRevoke = '*Link do grupo atualizado!!*\n @revoke'
